...
{
    [AddComponentMenu("")]
    public class AgoraNetworkManager : NetworkManager
    {
        public static new AgoraNetworkManager singleton { get; private set; }
        ...
        {
            base.OnStartClient();
            NetworkClient.RegisterHandler<CreatePlayerMessage>(OnCreatePlayer);
            PlayerPrefs.SetString("ServerAddress", networkAddress);
        }
        /// <summary>
        ...
        public override void OnServerReady(NetworkConnectionToClient conn)
        {
            ...
            {
                Debug.Log("OnServerReady identity not null");
            }
        }

        public override void OnServerAddPlayer(NetworkConnectionToClient conn)
        {
            StartCoroutine(WaitForNetID(conn));
        }
        ...
        IEnumerator AddPlayerDelayed(NetworkConnectionToClient conn)
        {
            ...
            yield return StartCoroutine(AddPlayer(conn));
        }

        IEnumerator AddPlayer(NetworkConnectionToClient conn)
        {
        ...
        public struct CreatePlayerMessage : NetworkMessage
        {
            ...
            {
                return $"CreatePlayerMessage: name={name}";
            }
        }
        ...
        {
            Debug.Log("CreatePlayerMessage: " + createPlayerMessage);
        ...
        {
            networkAddress = PlayerPrefs.GetString("ServerAddress", "localhost");
        }
    }

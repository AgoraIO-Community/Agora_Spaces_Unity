...
namespace Agora.Spaces
{
    public class MediaTV : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            GameApplication.Instance.OnSceneChangeNotify += OnSceneChanged;
            GameApplication.Instance.OnGameStop += OnDisable;
        }

        IEnumerator InitMediaPlayer()
        {
            yield return new WaitUntil(() => AgoraSpaceController.Instance.RtcEngine != null && AgoraSpaceController.Instance.JoinedChannel);
            RtcEngine = AgoraSpaceController.Instance.RtcEngine;
            UidUseInEx = AgoraSpaceController.Instance.LocalUID;
        ...
        void SpatialAudioStart()
        {
            ...
            var rc = AgoraSpaceController.Instance.SpatialAudioController.UpdateRemotePositionEx(UidUseInMPK, remotePosInfo,
            new RtcConnection(AgoraSpaceController.Instance.ChannelID, UidUseInEx));
        }
